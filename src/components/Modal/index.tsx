...
const AddModal = ({
  ...
  return (
    <div
      ...
      <div
        className='w-full h-full bg-black opacity-40 absolute top-0 left-0 z-20'
        onClick={closeModal}></div>
      <div className='md:w-[30vw] w-[90%] bg-white rounded-lg shadow-lg z-50 flex flex-col itesm-center gap-3 px-5 py-6'>
        <input
          type='text'
          name='title'
